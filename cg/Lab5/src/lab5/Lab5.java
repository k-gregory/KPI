...
public class Lab5 extends JFrame {
    ...
    private void configureWindow()  {
        setTitle("Cat Animation Example");
        setSize(760,640);
    ...
    private void addModelToUniverse() throws IOException{
        scene = getSceneFromFile("C:\\Users\\Nadine\\Desktop\\2 семестр\\Комп.графика\\Lab5\\Lab5\\resources\\Cat.obj");//"D://toyplane.obj"
    ...
    private void setPlaneElementsList() {
        ...
        root.removeChild(nameMap.get("unnamed_group"));
        wholePlane.addChild(nameMap.get("unnamed_group"));
    ...
    Material getMaterial() {
        ...
        material.setAmbientColor ( new Color3f (Color.ORANGE ) );
        material.setDiffuseColor ( new Color3f( Color.ORANGE ) );
    ...
    private void addAppearance(){
        ...
        planeAppearance.setTexture(getTexture("C:\\Users\\Nadine\\Desktop\\2 семестр\\Комп.графика\\Lab5\\Lab5\\resources\\bear.jpg"));
        ...
        Shape3D plane = nameMap.get("unnamed_group");
    ...
    private void addImageBackground(){
        TextureLoader t = new TextureLoader("C:\\Users\\Nadine\\Desktop\\2 семестр\\Комп.графика\\Lab5\\Lab5\\resources\\lug.jpg", canvas);
    ...
    private void ChangeViewAngle(){
        ...
        Vector3f translationVector = new Vector3f(0.0F, 1F, 8F);
